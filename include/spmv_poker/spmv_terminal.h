 ...
 */
struct TiledRankSummaryRiverTerminalOperator final : RiverTerminalOperator {
  TiledRankSummaryRiverTerminalOperator(const TerminalTables &tables,
                                        uint64_t flop_mask);
