...
/**
 * Precomputed terminal evaluation for every possible runout
 *
 * hand_table is the canonical list of hands that do not overlap the board.
 * The rest of the terminal results are computed using this canonical ordering
 *
...
struct TerminalTables {
  ...
  void apply_fold(const Range &opponent_range, float payoff,
